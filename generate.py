        ...
        "steps": [
            ...
            },
            {
                ...
                "sub_steps": [
                    ...
                    {
                        "id": "4.8", "name": "异常单自动指派与升级",
                        "desc": "当工单生产结束时，系统自动启动异常单的指派排除流程。根据预先配置的处理小组规则，自动将异常单指派给对应的小组及人员进行处置，无需人工干预。同时系统支持配置超时升级规则：当异常单在某个环节超时未处理时，自动升级至上级处理人，确保异常不被遗漏。",
                        "remark": "自动指派基于工单信息匹配处理小组规则。超时升级每触发一次自动记录升级日志，通知相关人员。",
                        "images": []
                    }
                ]
            },
